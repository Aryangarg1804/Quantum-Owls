        ...
        <Card className="shadow-xl border-pink-200/40 dark:border-pink-800/40">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">
              {translate("Join Saheli to empower your journey", "अपनी यात्रा को सशक्त बनाने के लिए सहेली से जुड़ें")}
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            >
              <div className="flex items-center justify-center gap-3">
                ...
                <span>
                  {translate("Sign up with Google", "Google के साथ साइन अप करें")}
                </span>
              </div>
            </Button>
            ...
            <form onSubmit={onSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input 
                    ...
                    className="pl-9"
                    placeholder={translate("Enter your full name", "अपना पूरा नाम दर्ज करें")}
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input 
                    ...
                    className="pl-9 pr-9"
                    placeholder={translate("Create a password", "पासवर्ड बनाएं")}
                  />
                  <button
                    type="button"
              ...
              <div className="space-y-2">
                <Label htmlFor="confirmPassword">
                  {translate("Confirm Password", "पासवर्ड की पुष्टि करें")}
                </Label>
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-saheli-purple/60" />
                  <Input 
                    ...
                    className="pl-9 pr-9"
                    placeholder={translate("Confirm your password", "अपने पासवर्ड की पुष्टि करें")}
                  />
                  <button
                    type="button"
                    className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground hover:text-foreground"
              ...
              >
                {isSubmitting ? (
                  <div className="flex items-center gap-2">
                    ...
                    {translate("Creating account...", "खाता बनाया जा रहा है...")}
                  </div>
                ) : (
                  <div className="flex items-center gap-2">
                    <UserPlus className="h-4 w-4" />
                    {translate("Create Account", "खाता बनाएं")}
                  </div>
                )}
              </Button>
            </form>
            ...
            <div className="mt-4 text-center text-sm">
              {translate("Already have an account?", "पहले से खाता है?")} 
              <Link className="text-saheli-purple underline ml-1" to="/login">
